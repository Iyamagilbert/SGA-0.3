...
img {
  ...
  -ms-animation: dance 4s infinite;
  position: absolute;
  top: 200px;
  left: 400px;
}
...
$(".color").click(function() {
  ...
  // Generate an RGBA value from red, greeen, and blue
  var randomRGBA = 'rgba('+red+','+green+','+blue+',1)'
  
  // and change the body's background to our randomcolor
  $("body").css("background", randomRGBA);
  //Display the RGBA in an alert window
  //alert(randomRGBA);
});
